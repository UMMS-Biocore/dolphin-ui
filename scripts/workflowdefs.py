...
stepHaplotype = 'stepHaplotype%(sep)s@RUNHAPLOTYPE -o @OUTDIR -g @GENOMEFASTA -bed @BEDTOOLSSECT -ha @HAPLOTYPECMD -pi @PICARDCMD -smctfc @SMCTFC -smctfe @SMCTFE -mb @MBQS -mrp @MRPAS -mri @MRIRPS -co @COMMON -cl @CLINICAL -mo @MOTIFS -se stepHaplotype -j @JOB%(sep)s60'
