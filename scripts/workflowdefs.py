...
stepDeeptools='stepDeeptools%(sep)s@RUNDEEPTOOLS -d @DEEPTOOLSHEAT -c @COMPDEEPTOOLS -g @GENOMEBED -p @PLOTTYPE -r @REFTYPE -t %(type)s -o @OUTDIR -s stepDeeptools -j @JOB%(sep)s60'
