...
if($p == "experiments"){
	...
	$data = "This table represents all of the Imports you have access to viewing.
			...
			are supplies on sample imports.  The status can be 1 of 6 colors: light grey means the backup is pending, red stands for an amazon checksum mismatch,
			pink means the checksum has changed from the original checksum of the files, dark grey means the original fastq file created is missing,
			blue means the backup has no errors but is over 2 months old, and green means the upload is current.
			<br><br>
